  ...
  <div class="container mt-5">
    ...
    action="<?= site_url('/update') ?>">
      ...
      <div class="form-group">
        <label>Name</label>
        <input type="text" name="name" class="form-control" value="<?php echo $product_obj['name']; ?>">
      </div>
      ...
      <div class="form-group">
        <label>Price</label>
        <input type="number" name="price" class="form-control" value="<?php echo $product_obj['price']; ?>">
      </div>
